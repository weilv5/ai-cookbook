...
> ⚠️ **数据时效说明**
>
> - 价格、模型名随时变化，本文价格仅作参考，**以各厂商官方控制台当下显示为准**。
> - 上次集中核验时间：**2026-04**
> - 如果你发现文中价格/模型已经过时，欢迎提 PR 或 Issue 反馈
...
4. **价格变动**：本文价格为 2026-04 公开价格快照，实际以各厂商官网最新公布为准

## 更新记录

- 2026-07-12：补充顶部「数据时效说明」banner，提醒读者以官网为准
